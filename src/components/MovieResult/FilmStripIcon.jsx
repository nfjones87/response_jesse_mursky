...
const FilmStripSVG = () => (
  <FlexBox
    ...
    alignContent="center"
    style={{ height: "100%", width: "100%", backgroundColor: "lightGrey" }}
  >
    <svg
      version="1.1"
      id="Capa_1"
    ...
    >
      <g>
        <path
          d="M23.415,0v1.923h-2.249V0h-1.39v0.945H8.383V0H6.78v1.966H4.53V0H3.626v1.513v1.385v21.354v1.385v2.521h0.778v-2.252h2.25
